import { d as createAstro, c as createComponent, m as maybeRenderHead, u as unescapeHTML, a as renderTemplate, r as renderComponent, F as Fragment, e as renderScript, b as addAttribute } from '../chunks/astro/server_DSUpihBA.mjs';
import 'kleur/colors';
import { $ as $$Button, a as $$PageLayout } from '../chunks/PageLayout_dlFw0N0L.mjs';
...
}, "/Users/juanpelaez/gitkubekub/kubekub.com/src/components/widgets/HeroText.astro", void 0);
...
const $$Form = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<form id="contactForm"> ${inputs && inputs.map(
...
}, "/Users/juanpelaez/gitkubekub/kubekub.com/src/components/widgets/Contact.astro", void 0);
...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroText", $$HeroText, { "tagline": "Contact", "title": "Let's Connect!" })} ${renderComponent($$result2, "ContactUs", $$Contact$1, { "id": "form", "title": "Drop us a message today!", "subtitle": "For quicker answers, explore our FAQs section. You may find the solution you're looking  for right there! If not, our support team is delighted to help you.", "inputs": [
    ...
    },
    {
      ...
      callToAction: {
        text: "Visit Profile",
        href: "https://linkedin.com/company/kubekub",
        target: "_blank"
      }
    }
  ] })} ` })}`;
}, "/Users/juanpelaez/gitkubekub/kubekub.com/src/pages/contact.astro", void 0);

const $$file = "/Users/juanpelaez/gitkubekub/kubekub.com/src/pages/contact.astro";
const $$url = "/contact";
