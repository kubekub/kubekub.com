...
const SITE = {"name":"Kubekub","site":"https://Kubekub.vercel.app","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M"};
                    const I18N = {"language":"en","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"Kubekub","template":"%s — Kubekub"},"description":"🚀 Suitable for Startups, Small Business, Sass Websites, Professional Portfolios, Marketing Websites, Landing Pages & Blogs.","openGraph":{"type":"website","site_name":"Kubekub","images":[{"url":"~/assets/images/default.png","width":1200,"height":628}]},"twitter":{"handle":"@arthelokyo","site":"@arthelokyo","cardType":"summary_large_image"}};
